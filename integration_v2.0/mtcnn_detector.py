...
class MtcnnDetector(object):
    ...
    # This func may not detect the face, I don't know why
    def detect_face_limited(self, img, det_type=2):
        ...
        print('total_boxes size is: ', total_boxes.shape)
        print('points size is: ', points.shape)

...
parser.add_argument('--model', default='/home/george/project/Face_detect_recognition_all/InsightFace/insightface/models/model-r34-amf/model,0', help='path to load model.')
...
for line in libList.readlines():
	if num_face > 0:
		face_path = os.path.join('Mr.Wang', line[:-1])
		print(face_path)
...
np.save('lib_feature_wang.npy', lib_feature)
